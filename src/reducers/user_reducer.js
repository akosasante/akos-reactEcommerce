import {
  ...
  LOGOUT_SUCCESS,
  REGISTER_BEGIN, REGISTER_ERROR,
  REGISTER_SUCCESS
} from "../actions";

const user_reducer = (state, action) => {
  if ((action.type === LOGIN_BEGIN) || (action.type === REGISTER_BEGIN) || (action.type === LOGOUT_BEGIN)) {
    return { ...state, authLoading: true };
  }

  if ((action.type === LOGIN_ERROR) || (action.type === REGISTER_ERROR) || (action.type === LOGOUT_ERROR)) {
